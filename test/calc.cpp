...
class Binary {
   ...
   private:
    ...
    template <std::size_t I, typename FwdBinary,
              std::enable_if_t<
                  std::is_base_of_v<Binary, std::decay_t<FwdBinary>>, int> = 0>
...
template <>
class tuple_size<calc::Func> : public tuple_size<calc::Unary> {};
template <>
class tuple_size<calc::Plus> : public tuple_size<calc::Binary> {};
template <>
class tuple_size<calc::Mult> : public tuple_size<calc::Binary> {};
